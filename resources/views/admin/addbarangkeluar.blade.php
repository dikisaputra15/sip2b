...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ url('admin/storebarangkeluar') }}">
            @csrf

            <div class="row mb-3">
                <label for="fullname" class="col-md-4 col-form-label text-md-end">Tanggal Barang Keluar</label>
                <div class="col-md-6">
                    <input id="tgl_barang_keluar" type="date" class="form-control" name="tgl_barang_keluar" required>
                </div>
            </div>

            <div class="row mb-3">
                <label for="date_of_birtht" class="col-md-4 col-form-label text-md-end">Nama Petugas</label>
                <div class="col-md-6">
            ...
            <div class="control-group after-add-more10">
                      <div class="form-group">
                          <div class="col-xs-6">
                              <label for="first_name"><h4>Uraian Barang Keluar</h4></label>
                      ...
                      <div class="form-group">
                          <div class="col-xs-5">
                             <label for="mobile"><h4>Jumlah Barang Keluar</h4></label>
